...
export function Pricing() {
  return (
    <section className="relative px-4 py-20 md:py-24" id="pricing">
      {/* Subtle glow */}
      <div className="absolute right-0 top-1/2 -translate-y-1/2 h-[400px] w-[400px] rounded-full bg-primary/5 blur-[100px]" />
      
      <div className="relative mx-auto max-w-6xl">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight md:text-4xl">
            Choose Your <span className="text-primary">Setup</span>
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Professional website setup with automation tools built in
          </p>
        </div>
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {plans.map((plan) => (
            <Card
              key={plan.name}
              className={cn(
                "relative flex flex-col border-border/50 bg-card/50 backdrop-blur transition-all duration-300 hover:border-primary/30",
